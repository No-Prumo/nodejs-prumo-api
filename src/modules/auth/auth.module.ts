...
import { MagicLinkTokenService } from './application/services/magic-link-token.service';
...
import { ConsumeMagicLinkController } from './presentation/http/consume-magic-link.controller';
import { RequestMagicLinkController } from './presentation/http/request-magic-link.controller';
