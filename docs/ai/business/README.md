---
title: Backend Business Rules Pointer
doc-type: pointer
role: pointer
priority: high
...
read-when:
  ...
  - an old docs/ai/business path is referenced
do-not-read-when:
  - changing backend architecture, config, logging, CI, or tests only
---

# Backend Business Rules Pointer
